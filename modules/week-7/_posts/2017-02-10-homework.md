...
In this homework, we are going to connect our database queries to our pages.

1. Connect MS SQL Server to ASP.NET
2. Connect MySQL to PHP
3. Insert a new player and display them.
